...
- **SceneManager** – Instantiable scene service owned by the engine. Tests and tools can spin up isolated managers without touching the main runtime.
...
auto scene = sceneManager.LoadScene("Level1");
